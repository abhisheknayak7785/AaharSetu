    ...
    return (
        <div className="page-container">
            <div className="page-header fade-in-up">
                <h1>
                    <span style={{
                        ...
                        borderRadius: '50%', background: 'var(--ration-white)',
                        marginRight: 8
                    }}></span>
                    White Ration Card
                </h1>
            ...
            <div className="info-card fade-in-up" style={{animationDelay: '0.2s'}}>
                ...
                <ul>
                    <li>The Families having annual income of Rs.1 Lakh or above, any member of the family possessing a four-wheeler or the family aggregately holding more than 4 hectare irrigated land are issued white ration cards.</li>
                </ul>
            </div>
        </div>
    );
