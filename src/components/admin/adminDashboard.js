...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    axios
      .get(`${API_URL}/api/admin/analytics`, {
  ...
  return (
    <div className="fade-in-up">
      ...
      <div className="card-grid card-grid-3">
        ...
        <div className="stat-card">
          ...
          <div className="stat-card-info">
            ...
            <div className="stat-value">
              {analytics.counts?.totalTransactions || 0}
            </div>
          </div>
        </div>
      </div>
      ...
      <div
        className="card mt-4 p-4 shadow-sm"
          ...
          <tbody>
            {analytics.recentTransactions?.map((t) => (
              <tr key={t._id}>
                ...
                <td>
                  Rice: {t.itemsDistributed?.rice || 0}kg, Wheat:{" "}
                  {t.itemsDistributed?.wheat || 0}kg
                </td>
              </tr>
            ))}
          </tbody>
